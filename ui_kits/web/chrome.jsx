...
function Header({ setPage, cartCount, openCart, favCount, currentPage }) {
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('header', {
      ...
      mobileOpen && React.createElement('aside', { style:{ position:'fixed',top:0,left:0,bottom:0,width:'min(320px,82vw)',background:'#F7F2EB',zIndex:70,display:'flex',flexDirection:'column',boxShadow:'8px 0 32px rgba(44,36,22,0.18)',animation:'slideLeft 0.3s cubic-bezier(0.4,0,0.2,1) reverse' } },
